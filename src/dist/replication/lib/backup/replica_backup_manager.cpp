...
void replica_backup_manager::clear_backup(const std::string &policy_name, int64_t backup_id)
{
    tasking::enqueue(
        LPC_BACKGROUND_COLD_BACKUP,
        &_replica->_tracker,
        [this, policy_name, backup_id]() { clear_backup_checkpoint(policy_name, backup_id); },
