...
update_group_partition_count_request::update_group_partition_count_request(
    const update_group_partition_count_request &other626)
{
    target_address = other626.target_address;
    new_partition_count = other626.new_partition_count;
    pid = other626.pid;
    ballot = other626.ballot;
    update_child_group = other626.update_child_group;
    __isset = other626.__isset;
}
update_group_partition_count_request::update_group_partition_count_request(
    update_group_partition_count_request &&other627)
{
    target_address = std::move(other627.target_address);
    new_partition_count = std::move(other627.new_partition_count);
    pid = std::move(other627.pid);
    ballot = std::move(other627.ballot);
    update_child_group = std::move(other627.update_child_group);
    __isset = std::move(other627.__isset);
}
update_group_partition_count_request &update_group_partition_count_request::
operator=(const update_group_partition_count_request &other628)
{
    target_address = other628.target_address;
    new_partition_count = other628.new_partition_count;
    pid = other628.pid;
    ballot = other628.ballot;
    update_child_group = other628.update_child_group;
    __isset = other628.__isset;
    return *this;
}
update_group_partition_count_request &update_group_partition_count_request::
operator=(update_group_partition_count_request &&other629)
{
    target_address = std::move(other629.target_address);
    new_partition_count = std::move(other629.new_partition_count);
    pid = std::move(other629.pid);
    ballot = std::move(other629.ballot);
    update_child_group = std::move(other629.update_child_group);
...
update_group_partition_count_response::update_group_partition_count_response(
    const update_group_partition_count_response &other630)
{
    err = other630.err;
    __isset = other630.__isset;
}
update_group_partition_count_response::update_group_partition_count_response(
    update_group_partition_count_response &&other631)
{
    err = std::move(other631.err);
    __isset = std::move(other631.__isset);
}
update_group_partition_count_response &update_group_partition_count_response::
operator=(const update_group_partition_count_response &other632)
{
    err = other632.err;
...
update_group_partition_count_response &update_group_partition_count_response::
operator=(update_group_partition_count_response &&other633)
{
...
register_child_request::register_child_request(const register_child_request &other634)
{
    app = other634.app;
    parent_config = other634.parent_config;
    child_config = other634.child_config;
    primary_address = other634.primary_address;
    __isset = other634.__isset;
}
register_child_request::register_child_request(register_child_request &&other635)
{
    app = std::move(other635.app);
    parent_config = std::move(other635.parent_config);
    child_config = std::move(other635.child_config);
    primary_address = std::move(other635.primary_address);
    __isset = std::move(other635.__isset);
}
register_child_request &register_child_request::operator=(const register_child_request &other636)
{
    app = other636.app;
    parent_config = other636.parent_config;
    child_config = other636.child_config;
    primary_address = other636.primary_address;
    __isset = other636.__isset;
    return *this;
}
register_child_request &register_child_request::operator=(register_child_request &&other637)
{
    app = std::move(other637.app);
    parent_config = std::move(other637.parent_config);
    child_config = std::move(other637.child_config);
    primary_address = std::move(other637.primary_address);
...
register_child_response::register_child_response(const register_child_response &other638)
{
    err = other638.err;
    app = other638.app;
...
register_child_response::register_child_response(register_child_response &&other639)
{
...
register_child_response &register_child_response::operator=(const register_child_response &other640)
{
    err = other640.err;
    app = other640.app;
...
register_child_response &register_child_response::operator=(register_child_response &&other641)
{
