...
configuration_update_app_env_request::configuration_update_app_env_request(const configuration_update_app_env_request& other486) {
...
configuration_update_app_env_request::configuration_update_app_env_request( configuration_update_app_env_request&& other487) {
...
configuration_update_app_env_request& configuration_update_app_env_request::operator=(const configuration_update_app_env_request& other488) {
...
configuration_update_app_env_request& configuration_update_app_env_request::operator=(configuration_update_app_env_request&& other489) {
...
configuration_update_app_env_response::configuration_update_app_env_response(const configuration_update_app_env_response& other490) {
  err = other490.err;
  hint_message = other490.hint_message;
  __isset = other490.__isset;
}
configuration_update_app_env_response::configuration_update_app_env_response( configuration_update_app_env_response&& other491) {
  err = std::move(other491.err);
  hint_message = std::move(other491.hint_message);
  __isset = std::move(other491.__isset);
}
configuration_update_app_env_response& configuration_update_app_env_response::operator=(const configuration_update_app_env_response& other492) {
  err = other492.err;
  hint_message = other492.hint_message;
  __isset = other492.__isset;
  return *this;
}
configuration_update_app_env_response& configuration_update_app_env_response::operator=(configuration_update_app_env_response&& other493) {
...
duplication_add_response& duplication_add_response::operator=(const duplication_add_response& other500) {
  err = other500.err;
...
duplication_modify_request& duplication_modify_request::operator=(const duplication_modify_request& other506) {
...
duplication_modify_request& duplication_modify_request::operator=(duplication_modify_request&& other507) {
...
duplication_modify_response::duplication_modify_response(const duplication_modify_response& other508) {
  err = other508.err;
...
duplication_modify_response& duplication_modify_response::operator=(const duplication_modify_response& other510) {
  err = other510.err;
  appid = other510.appid;
  __isset = other510.__isset;
  return *this;
}
duplication_modify_response& duplication_modify_response::operator=(duplication_modify_response&& other511) {
...
duplication_query_request& duplication_query_request::operator=(const duplication_query_request& other528) {
  app_name = other528.app_name;
  __isset = other528.__isset;
  return *this;
}
duplication_query_request& duplication_query_request::operator=(duplication_query_request&& other529) {
...
duplication_query_response& duplication_query_response::operator=(const duplication_query_response& other538) {
  err = other538.err;
...
duplication_query_response& duplication_query_response::operator=(duplication_query_response&& other539) {
...
duplication_confirm_entry& duplication_confirm_entry::operator=(const duplication_confirm_entry& other542) {
  dupid = other542.dupid;
  confirmed_decree = other542.confirmed_decree;
  __isset = other542.__isset;
  return *this;
}
duplication_confirm_entry& duplication_confirm_entry::operator=(duplication_confirm_entry&& other543) {
        ...
        if (ftype == ::apache::thrift::protocol::T_MAP) {
          {
            ...
            for (_i548 = 0; _i548 < _size544; ++_i548)
            {
              ...
              std::vector<duplication_confirm_entry> & _val550 = this->confirm_list[_key549];
              {
                _val550.clear();
                uint32_t _size551;
...
uint32_t duplication_sync_request::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("confirm_list", ::apache::thrift::protocol::T_MAP, 2);
  {
    ...
    for (_iter556 = this->confirm_list.begin(); _iter556 != this->confirm_list.end(); ++_iter556)
    {
      xfer += _iter556->first.write(oprot);
      {
        xfer += oprot->writeListBegin(::apache::thrift::protocol::T_STRUCT, static_cast<uint32_t>(_iter556->second.size()));
        std::vector<duplication_confirm_entry> ::const_iterator _iter557;
        for (_iter557 = _iter556->second.begin(); _iter557 != _iter556->second.end(); ++_iter557)
        {
...
duplication_sync_request& duplication_sync_request::operator=(const duplication_sync_request& other560) {
  node = other560.node;
...
uint32_t duplication_sync_response::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("dup_map", ::apache::thrift::protocol::T_MAP, 2);
  {
    ...
    for (_iter576 = this->dup_map.begin(); _iter576 != this->dup_map.end(); ++_iter576)
    {
      ...
      {
        xfer += oprot->writeMapBegin(::apache::thrift::protocol::T_I32, ::apache::thrift::protocol::T_STRUCT, static_cast<uint32_t>(_iter576->second.size()));
...
duplication_sync_response& duplication_sync_response::operator=(const duplication_sync_response& other580) {
  err = other580.err;
  dup_map = other580.dup_map;
  __isset = other580.__isset;
  return *this;
}
duplication_sync_response& duplication_sync_response::operator=(duplication_sync_response&& other581) {
...
app_partition_split_request::app_partition_split_request(const app_partition_split_request& other610) {
...
app_partition_split_request& app_partition_split_request::operator=(const app_partition_split_request& other612) {
  app_name = other612.app_name;
  new_partition_count = other612.new_partition_count;
  __isset = other612.__isset;
  return *this;
}
app_partition_split_request& app_partition_split_request::operator=(app_partition_split_request&& other613) {
...
app_partition_split_response::app_partition_split_response(const app_partition_split_response& other614) {
  err = other614.err;
...
app_partition_split_response& app_partition_split_response::operator=(const app_partition_split_response& other616) {
  err = other616.err;
...
app_partition_split_response& app_partition_split_response::operator=(app_partition_split_response&& other617) {
...
notify_cacth_up_response& notify_cacth_up_response::operator=(const notify_cacth_up_response& other624) {
  err = other624.err;
