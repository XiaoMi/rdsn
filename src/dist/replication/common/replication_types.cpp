...
update_group_partition_count_request::update_group_partition_count_request(
    const update_group_partition_count_request &other630)
{
    target_address = other630.target_address;
    new_partition_count = other630.new_partition_count;
    pid = other630.pid;
    ballot = other630.ballot;
    update_child_group = other630.update_child_group;
    __isset = other630.__isset;
}
update_group_partition_count_request::update_group_partition_count_request(
    update_group_partition_count_request &&other631)
{
    ...
    update_child_group = std::move(other631.update_child_group);
    __isset = std::move(other631.__isset);
}
update_group_partition_count_request &update_group_partition_count_request::
operator=(const update_group_partition_count_request &other632)
{
    target_address = other632.target_address;
    new_partition_count = other632.new_partition_count;
    pid = other632.pid;
    ballot = other632.ballot;
    update_child_group = other632.update_child_group;
    __isset = other632.__isset;
    return *this;
}
update_group_partition_count_request &update_group_partition_count_request::
operator=(update_group_partition_count_request &&other633)
{
    ...
    update_child_group = std::move(other633.update_child_group);
...
update_group_partition_count_response::update_group_partition_count_response(
    const update_group_partition_count_response &other634)
{
    err = other634.err;
    __isset = other634.__isset;
}
update_group_partition_count_response::update_group_partition_count_response(
    update_group_partition_count_response &&other635)
{
    err = std::move(other635.err);
    __isset = std::move(other635.__isset);
}
update_group_partition_count_response &update_group_partition_count_response::
operator=(const update_group_partition_count_response &other636)
{
    err = other636.err;
...
update_group_partition_count_response &update_group_partition_count_response::
operator=(update_group_partition_count_response &&other637)
{
