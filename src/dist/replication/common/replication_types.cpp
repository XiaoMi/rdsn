...
duplication_modify_request::duplication_modify_request(const duplication_modify_request &other503)
{
    app_name = other503.app_name;
    dupid = other503.dupid;
    status = other503.status;
    __isset = other503.__isset;
}
duplication_modify_request::duplication_modify_request(duplication_modify_request &&other504)
{
    app_name = std::move(other504.app_name);
    dupid = std::move(other504.dupid);
    status = std::move(other504.status);
    __isset = std::move(other504.__isset);
}
duplication_modify_request &duplication_modify_request::
operator=(const duplication_modify_request &other505)
{
    app_name = other505.app_name;
    dupid = other505.dupid;
    status = other505.status;
    __isset = other505.__isset;
    return *this;
}
duplication_modify_request &duplication_modify_request::
operator=(duplication_modify_request &&other506)
{
    app_name = std::move(other506.app_name);
    dupid = std::move(other506.dupid);
    status = std::move(other506.status);
...
duplication_modify_response::duplication_modify_response(
    const duplication_modify_response &other507)
{
    err = other507.err;
    appid = other507.appid;
    __isset = other507.__isset;
}
duplication_modify_response::duplication_modify_response(duplication_modify_response &&other508)
{
...
duplication_modify_response &duplication_modify_response::
operator=(const duplication_modify_response &other509)
{
    err = other509.err;
    appid = other509.appid;
    __isset = other509.__isset;
    return *this;
}
duplication_modify_response &duplication_modify_response::
operator=(duplication_modify_response &&other510)
{
    err = std::move(other510.err);
    appid = std::move(other510.appid);
    ...
    while (true) {
        ...
        case 2:
            if (ftype == ::apache::thrift::protocol::T_I32) {
                ...
                this->status = (duplication_status::type)ecast511;
                this->__isset.status = true;
            } else {
                xfer += iprot->skip(ftype);
            }
            ...
            if (ftype == ::apache::thrift::protocol::T_MAP) {
                {
                    ...
                    for (_i516 = 0; _i516 < _size512; ++_i516) {
                        int32_t _key517;
                        xfer += iprot->readI32(_key517);
                        int64_t &_val518 = this->progress[_key517];
                        xfer += iprot->readI64(_val518);
                    }
                    xfer += iprot->readMapEnd();
                }
                this->__isset.progress = true;
            ...
            if (ftype == ::apache::thrift::protocol::T_MAP) {
                {
                    ...
                    for (_i523 = 0; _i523 < _size519; ++_i523) {
                        ...
                        int64_t &_val525 = this->not_confirmed[_key524];
...
uint32_t duplication_entry::write(::apache::thrift::protocol::TProtocol *oprot) const
{
    ...
    if (this->__isset.not_confirmed) {
        xfer += oprot->writeFieldBegin("not_confirmed", ::apache::thrift::protocol::T_MAP, 6);
        {
            ...
            for (_iter527 = this->not_confirmed.begin(); _iter527 != this->not_confirmed.end();
                 ++_iter527) {
...
duplication_entry::duplication_entry(const duplication_entry &other528)
{
    ...
    not_confirmed = other528.not_confirmed;
...
duplication_entry::duplication_entry(duplication_entry &&other529)
{
    ...
    not_confirmed = std::move(other529.not_confirmed);
...
duplication_entry &duplication_entry::operator=(const duplication_entry &other530)
{
    ...
    not_confirmed = other530.not_confirmed;
...
duplication_entry &duplication_entry::operator=(duplication_entry &&other531)
{
    ...
    not_confirmed = std::move(other531.not_confirmed);
...
app_partition_split_request::app_partition_split_request(
    const app_partition_split_request &other616)
{
    app_name = other616.app_name;
    new_partition_count = other616.new_partition_count;
    __isset = other616.__isset;
}
app_partition_split_request::app_partition_split_request(app_partition_split_request &&other617)
{
...
app_partition_split_request &app_partition_split_request::
operator=(const app_partition_split_request &other618)
{
...
app_partition_split_request &app_partition_split_request::
operator=(app_partition_split_request &&other619)
{
...
app_partition_split_response::app_partition_split_response(
    const app_partition_split_response &other620)
{
    err = other620.err;
...
app_partition_split_response::app_partition_split_response(app_partition_split_response &&other621)
{
...
app_partition_split_response &app_partition_split_response::
operator=(const app_partition_split_response &other622)
{
    err = other622.err;
...
app_partition_split_response &app_partition_split_response::
operator=(app_partition_split_response &&other623)
{
...
notify_catch_up_request::notify_catch_up_request(const notify_catch_up_request &other624)
{
...
notify_catch_up_request::notify_catch_up_request(notify_catch_up_request &&other625)
{
...
notify_catch_up_request &notify_catch_up_request::operator=(const notify_catch_up_request &other626)
{
...
notify_catch_up_request &notify_catch_up_request::operator=(notify_catch_up_request &&other627)
{
...
notify_cacth_up_response::notify_cacth_up_response(const notify_cacth_up_response &other628)
{
    err = other628.err;
    __isset = other628.__isset;
}
notify_cacth_up_response::notify_cacth_up_response(notify_cacth_up_response &&other629)
{
    err = std::move(other629.err);
    __isset = std::move(other629.__isset);
}
notify_cacth_up_response &notify_cacth_up_response::
operator=(const notify_cacth_up_response &other630)
{
    err = other630.err;
    __isset = other630.__isset;
    return *this;
}
notify_cacth_up_response &notify_cacth_up_response::operator=(notify_cacth_up_response &&other631)
{
