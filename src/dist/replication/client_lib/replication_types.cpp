...
app_partition_split_request::app_partition_split_request(const app_partition_split_request& other455) {
  app_name = other455.app_name;
  new_partition_count = other455.new_partition_count;
  __isset = other455.__isset;
}
app_partition_split_request::app_partition_split_request( app_partition_split_request&& other456) {
  app_name = std::move(other456.app_name);
  new_partition_count = std::move(other456.new_partition_count);
  __isset = std::move(other456.__isset);
}
app_partition_split_request& app_partition_split_request::operator=(const app_partition_split_request& other457) {
  app_name = other457.app_name;
  new_partition_count = other457.new_partition_count;
  __isset = other457.__isset;
  return *this;
}
app_partition_split_request& app_partition_split_request::operator=(app_partition_split_request&& other458) {
  app_name = std::move(other458.app_name);
  new_partition_count = std::move(other458.new_partition_count);
...
void app_partition_split_response::__set_appid(const int32_t val) {
  this->appid = val;
}
...
app_partition_split_response::app_partition_split_response(const app_partition_split_response& other459) {
  err = other459.err;
  appid = other459.appid;
  partition_count = other459.partition_count;
  __isset = other459.__isset;
}
app_partition_split_response::app_partition_split_response( app_partition_split_response&& other460) {
  err = std::move(other460.err);
  appid = std::move(other460.appid);
  partition_count = std::move(other460.partition_count);
  __isset = std::move(other460.__isset);
}
app_partition_split_response& app_partition_split_response::operator=(const app_partition_split_response& other461) {
  err = other461.err;
  appid = other461.appid;
  partition_count = other461.partition_count;
  __isset = other461.__isset;
  return *this;
}
app_partition_split_response& app_partition_split_response::operator=(app_partition_split_response&& other462) {
  err = std::move(other462.err);
  appid = std::move(other462.appid);
  partition_count = std::move(other462.partition_count);
