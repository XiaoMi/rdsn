...
#include "partition_guardian_test.h"
#include "misc/misc.h"
...
void partition_guardian_test::collect_replica()
{
    app_mapper app;
    node_mapper nodes;
...
#define CLEAR_ALL                                                                                  \
...

    {
        ...
        ASSERT_TRUE(guardian.collect_replica(view, node_list[0], rep));
    }
...

    {
        ...
        ASSERT_FALSE(guardian.collect_replica(view, node_list[5], rep));
    }

    {
        ...
        ASSERT_TRUE(guardian.collect_replica(view, node_list[4], rep));
...

    {
        ...
        rep.last_committed_decree = 3;
        rep.last_prepared_decree = 5;
        ASSERT_TRUE(guardian.collect_replica(view, node_list[5], rep));
        dropped_replica &d = cc.dropped.front();
...
TEST_F(partition_guardian_test, collect_replica) { collect_replica(); }
} // namespace replication
} // namespace dsn
