...
typedef struct _app_info__isset {
  _app_info__isset() : status(true), app_type(false), app_name(false), app_id(false), partition_count(false), envs(false), is_stateful(false), max_replica_count(false), expire_second(false), create_second(false), drop_second(false), duplicating(false), init_partition_count(true) {}
  bool status :1;
  bool app_type :1;
  bool app_name :1;
  bool app_id :1;
...
class app_info {
 public:
  ...
  app_info() : status((app_status::type)0), app_type(), app_name(), app_id(0), partition_count(0), is_stateful(0), max_replica_count(0), expire_second(0), create_second(0), drop_second(0), duplicating(0), init_partition_count(-1) {
