...
typedef struct _replica_configuration__isset {
  _replica_configuration__isset() : pid(false), ballot(false), primary(false), status(true), learner_signature(false), pop_all(true) {}
  bool pid :1;
  bool ballot :1;
  bool primary :1;
  bool status :1;
...
class replica_configuration {
 public:
  ...
  replica_configuration() : ballot(0), status((partition_status::type)0), learner_signature(0), pop_all(false) {
...
typedef struct _disk_info__isset {
  _disk_info__isset() : tag(false), full_dir(false), disk_capacity_mb(false), disk_available_mb(false), holding_primary_replica_counts(false), holding_secondary_replica_counts(false) {}
  bool tag :1;
  bool full_dir :1;
...
typedef struct _bulk_load_request__isset {
  _bulk_load_request__isset() : pid(false), app_name(false), primary_addr(false), remote_provider_name(false), cluster_name(false), ballot(false), meta_bulk_load_status(false), query_bulk_load_metadata(false) {}
  bool pid :1;
  bool app_name :1;
  bool primary_addr :1;
...
class bulk_load_request {
 public:
  ...
  bulk_load_request() : app_name(), remote_provider_name(), cluster_name(), ballot(0), meta_bulk_load_status((bulk_load_status::type)0), query_bulk_load_metadata(0) {
  }
...
typedef struct _group_bulk_load_request__isset {
  _group_bulk_load_request__isset() : app_name(false), target_address(false), config(false), provider_name(false), cluster_name(false), meta_bulk_load_status(false) {}
  bool app_name :1;
...
class group_bulk_load_request {
 public:
  ...
  group_bulk_load_request() : app_name(), provider_name(), cluster_name(), meta_bulk_load_status((bulk_load_status::type)0) {
  }
...
typedef struct _hotkey_detect_request__isset {
  _hotkey_detect_request__isset() : type(false), action(false), pid(false) {}
  bool type :1;
  bool action :1;
  bool pid :1;
