...
class update_child_group_partition_count_request {
 public:
  ...
  update_child_group_partition_count_request& operator=(update_child_group_partition_count_request&&);
...
class update_child_group_partition_count_response {
 public:
  ...
  update_child_group_partition_count_response& operator=(update_child_group_partition_count_response&&);
