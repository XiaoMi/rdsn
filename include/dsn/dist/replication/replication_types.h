...
class group_check_request {
 public:
  ...
  group_check_request() : last_committed_decree(0), confirmed_decree(0), meta_split_status((split_status::type)0) {
  }
...
class configuration_update_request {
 public:
  ...
  configuration_update_request() : type((config_type::type)0), meta_split_status((split_status::type)0) {
