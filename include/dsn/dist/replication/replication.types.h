...
namespace dsn { namespace replication { 
    ...
    GENERATED_TYPE_SERIALIZATION(app_env_set_request, THRIFT)
    GENERATED_TYPE_SERIALIZATION(app_env_del_request, THRIFT)
    GENERATED_TYPE_SERIALIZATION(app_env_clear_request, THRIFT)
